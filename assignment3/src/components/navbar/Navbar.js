    ...
    <div className="header">
      <nav className="navbar">
        ...
        <ul className={click ? "nav-menu active" : "nav-menu"}>
          ...
          <li className="nav-item">
            <Link to="education" spy={true} smooth={true} offset={-150} duration={500} onClick={closeMenu}>
              Education
            </Link>
          </li>
          <li className="nav-item">
            <Link to="skill" spy={true} smooth={true} offset={-100} duration={500} onClick={closeMenu}>
              Skill
            </Link>
          </li>
          <li className="nav-item">
